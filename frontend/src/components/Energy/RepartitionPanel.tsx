...
interface RepartitionPanelProps {
  title: string;
...
const RepartitionPanel: React.FC<RepartitionPanelProps> = ({
  title,
  data,
  color,
  nbCompteurs,
  ...
  return (
    <div className={`repartition-panel ${className}`}>
      <div className="panel panel-default">
        <div className="panel-heading">
          ...
          <div className="panel-subtitle">
            {nbCompteurs} unité{nbCompteurs > 1 ? "s" : ""} de répartition
          </div>
        </div>
              ...
              <div className="col-md-6">
                <div className="stat-item">
                  ...
                  <div className="stat-value">
                    {data[0]?.value || 0} {data[0]?.unit || "unités"}
                  </div>
                </div>
              </div>
              <div className="col-md-6">
...
export default RepartitionPanel;
