...
import { getOccupantApiService } from "@/services/api/Occupant/GetOccupantApiService";
import { getOccupantAccountApiService } from "@/services/api/Occupant/GetOccupantAccountApiService";
import { getOccupantInterventionApiService } from "@/services/api/Occupant/GetOccupantInterventionApiService";
import { listAnomaliesByOccupantApiService } from "@/services/api/Occupant/ListAnomaliesByOccupantApiService";
import { listDysfonctionnementsByOccupantApiService } from "@/services/api/Occupant/ListDysfonctionnementsByOccupantApiService";
import { listFuitesByOccupantApiService } from "@/services/api/Occupant/ListFuitesByOccupantApiService";
import { listInterventionsByOccupantApiService } from "@/services/api/Occupant/ListInterventionsByOccupantApiService";
import { listAlertesByOccupantApiService } from "@/services/api/Occupant/ListAlertesByOccupantApiService";
