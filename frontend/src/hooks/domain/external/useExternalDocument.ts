...
import { generateReportByTokenPdfApiService } from "@/services/api/External/Document/GenerateReportByTokenPdfApiService";
import { receiveGeneratedDocumentApiService } from "@/services/api/External/Document/ReceiveGeneratedDocumentApiService";
