/**
 * DTO for a single building/immeuble entity
 * Corresponds to: App\Domain\Entity\Immeuble
 */
export interface ImmeubleResponseDto {
  ...
  nbFuites: number | null;
  nbAnomalies: number | null;
  nbChantiers: number | null;
}
