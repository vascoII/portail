...
import IndicatorsSkeleton from "@/src/features/immeuble/components/IndicatorsSkeleton";
...
interface LogementIndicatorsPanelProps {
...
const LogementIndicatorsPanel: React.FC<LogementIndicatorsPanelProps> = ({
  indicators,
  loading,
  error,
  onRefresh,
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-medium text-red-800 mb-2">
              Erreur lors du chargement des indicateurs de logements
            </h3>
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-600 mb-2">
          Aucun indicateur de logement disponible
        </h3>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {indicators.map((indicator, index) => (
          <div
            key={`${indicator.pkLogement}-${index}`}
            className="bg-white rounded-lg shadow-md p-6 border border-gray-200"
          >
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-lg font-medium text-gray-800">
                Logement #{indicator.pkLogement}
              </h4>
...
export default LogementIndicatorsPanel;
