...
const OccupantLogementPage: React.FC = () => {
  ...
  // Vérifier que l'occupant a accès à ce logement
  const hasAccess = logement && logement.occupant.id === user?.id;
  ...
  if (error || !logement || !hasAccess) {
    return (
      <BaseLayout>
        <div className="alert alert-danger">
          Erreur : {error || "Logement non trouvé ou accès non autorisé"}
        </div>
      </BaseLayout>
    );
  }
...
export default OccupantLogementPage;
