...
use App\Domain\UseCase\Security\UpdatePasswordUseCase;
...
{
  public function __construct(private readonly ResponderInterface $responder, private readonly UpdatePasswordUseCase $useCase) {}

  public function __invoke(Request $request, array $args = []): Response
  {
    $input = new UpdatePasswordInputDto();
