...
use App\Application\UseCase\Occupant\DysfunctionsUseCase;
...
#[AsController]
#[Route(path: '/occupant/dysfonctionnements', name: 'occupant_list_dysfunctions', methods: ['GET'])]
final class ListDysfunctionsAction extends AbstractAction implements ActionInterface
{
  ...
  {
    $input = $this->inputFactory->createDysfunctionsFromRequest($request);
