...
use App\Application\UseCase\Ticketing\CloseTicketUseCase;
...
final class CloseTicketAction extends AbstractAction implements ActionInterface
{
  public function __construct(
    ...
    private readonly CloseTicketUseCase $useCase,
    private readonly TicketingInputFactory $inputFactory
  ) {}

  public function __invoke(Request $request, array $args = []): Response
  {
    $input = $this->inputFactory->createSetTicketStatusFromRequest($request);
