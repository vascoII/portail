...
final class GlobalExceptionListener implements EventSubscriberInterface
{
  ...
  private function convertSymfonyHttpException(HttpExceptionInterface $exception, Request $request): HttpException
  {
    ...
    return match ($statusCode) {
      400 => new \App\Http\Exception\BadRequestException(
      ...
      401 => new \App\Http\Exception\AuthenticationException(
        $exception->getMessage(),
        'Symfony',
        'http_exception',
        ['symfony_exception' => get_class($exception)],
      ...
      403 => new \App\Http\Exception\AuthorizationException(
        $exception->getMessage(),
        'Symfony',
        'http_exception',
        ['symfony_exception' => get_class($exception)],
      ...
      404 => new \App\Http\Exception\BadRequestException(
        'Resource not found',
        'Symfony',
        'http_exception',
        ['symfony_exception' => get_class($exception)],
      ...
      405 => new \App\Http\Exception\BadRequestException(
        'Method not allowed',
        'Symfony',
        'http_exception',
        ['symfony_exception' => get_class($exception)],
      ...
      422 => new \App\Http\Exception\BadRequestException(
      ...
      default => new \App\Http\Exception\InternalServerErrorException(
        $exception->getMessage(),
        'Symfony',
        'http_exception',
        ['symfony_exception' => get_class($exception)],
