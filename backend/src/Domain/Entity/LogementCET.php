...
class logementCET
{
  ...
  /**
   * 
   * @var InfosAppareilCET[] $ListeInfosAppareils
   * @access public
   */
   ...
   * @access public
   */
  public function __construct($ListeInfosAppareils, $Tot_URepart, $Tot_TantChauff, $PU_Tant, $Prix_URepart, $Prix_Abonn, $Mont_ARepartTant, $Part_RepartConsos, $CT_Combust, $URepartLog, $TantLog, $Prix_ChauffTantLog, $CT_ChauffLog, $SerieConsosDJU)
  {
